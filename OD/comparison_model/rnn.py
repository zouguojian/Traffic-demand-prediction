...
class rnn(object):
    ...
    def encoder(self):
        ...
        def cell():
            rnn_cell=tf.nn.rnn_cell.BasicRNNCell(num_units=self.nodes,reuse=tf.AUTO_REUSE)
            rnn_cell_=tf.nn.rnn_cell.DropoutWrapper(cell=rnn_cell,output_keep_prob=1.0)
            return rnn_cell_
