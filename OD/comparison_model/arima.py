...
if __name__ == "__main__":
    ...
    data = pd.read_csv(combine_path, encoding='utf-8')  # 数据读取
    print(data.keys())
    ...
    # for site in range(162):
    #     series=data.loc[data['ZoneID']==site]
    #     label, predict=evaluate_models(series.values[:,-1], p_values, d_values, q_values)
    #     labels.append(label)
